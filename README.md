...
Downloading terraform-aws-modules/bookstore-eks-vpc/aws 2.6.0 for bookstore-eks-vpc...
- bookstore-eks-vpc in .terraform/modules/bookstore-eks-vpc/terraform-aws-modules-terraform-aws-bookstore-eks-vpc-4b28d3d
...
In another terminal (do not close kubectl proxy terminal) create the ClusterRoleBinding resource.
```shell
...
# Remove the troublesome state file
```shell
terraform state rm 'module.eks.kubernetes_config_map.aws_auth[0]'
```

k8s-deepdive-eks-jD2Q94FL


```shell
aws eks --region eu-central-1 update-kubeconfig --name eks-k8s-bookstore-ZB5WmcZh
